...
/**
 *
 * @param {HTMLElement} radioElement
...
async function radioListernerAction (radioElement, radios) {
  ...
  radioElement.parentElement.classList.add('hide')
...
async function displayPhotographerData () {
  ...
  console.log('pouet', photographerData)
  ...
  document.getElementById('modal_photographer_name').innerText = photographer[0].name
